...
var video_to_skip = 0;
var video_array = [];
ZiggeoSdk.init(source_app_token, source_private_key);
...
function downloadVideo(video_array){
	...
	ZiggeoSdk.Videos.download_video(video_to_download, function(data){
		var file_name = 'temp_video/'+video_to_download+'.mp4';
		fs.writeFile(file_name, data, function(err){
            console.log('downloaded\n');
            ZiggeoSdk.init(target_app_token, target_private_key);
